...
class AdapterHashTest {

    @InjectMocks
    private AdapterHash adapterHash;
    ...
    void readCustomers_ShouldReturnNotNull() throws IOException {
        ...
        List<Customer> result = adapterHash.readCustomers(TEST_PATH);
    ...
    void readCustomers_ShouldThrowAccessDeniedException_WhenPathIsEmpty() throws IOException {
        ...
        assertThrows(AccessDeniedException.class, () -> adapterHash.readCustomers(""));
    ...
    void readCustomers_ShouldThrowNullPointerException_WhenPathIsNull() throws IOException {
        ...
        assertThrows(NullPointerException.class, () -> adapterHash.readCustomers(null));
